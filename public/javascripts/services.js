...
.factory('Show', ['$resource', 'baseURL', function($resource, baseURL){
...
.factory('Subscription', ['$http', function($http) {
    return {
        subscribe: function(show, uid) {
            return $http.post('subscription/subscribe', { showId: show._id, uid: uid });
        },
        unsubscribe: function(show, uid) {
            return $http.post('subscription/unsubscribe', { showId: show._id, uid: uid });
        }
    };
}])
    ...
    authFac.login = function(loginData) {
        ...
        .save(loginData,
            ...
            function(response){
                ...
                ngDialog.openConfirm({ template: message, plain: 'false'});
            }
